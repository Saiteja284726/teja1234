...
-- Table 2: Employee (Modified dept_id column to dept_id_foreign)
CREATE TABLE `employee` (
  ...
  `dept_id_foreign` INT DEFAULT NULL,  -- Changed column name to dept_id_foreign
  PRIMARY KEY (`emp_id`),
  FOREIGN KEY (`dept_id_foreign`) REFERENCES `department` (`dept_id`) ON DELETE SET NULL  -- Updated foreign key constraint
);
